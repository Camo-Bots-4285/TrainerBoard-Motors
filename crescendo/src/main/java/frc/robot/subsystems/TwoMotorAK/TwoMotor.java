    ...
    sysId =
        new SysIdRoutine(
            new SysIdRoutine.Config(
                ...
                null,
                null,
                (state) -> Logger.recordOutput("TwoMotor/SysIdState", state.toString())),
...
/*Gets the postion of the wheel and wraps it form 0 - 2PI */
  ...
  double setvoltage = TwoMotorConstants.PID_Positon_TWO_Motor.calculate(PosWarp,0);
    ...
    Logger.recordOutput("TwoMotor/PositionSetWrap", PosWarp);
    Logger.recordOutput("TwoMotor/PositonSetVoltage", PosWarp);
  }
