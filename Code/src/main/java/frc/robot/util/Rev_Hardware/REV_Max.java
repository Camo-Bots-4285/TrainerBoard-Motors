  ...
  public REV_Max(
    ...
    /*Identifies Motor and encoder*/
        ...
        .idleMode(RunningIdle);
          ...
          .p(TunnerValues[0],ClosedLoopSlot.kSlot0)
          .i(TunnerValues[1],ClosedLoopSlot.kSlot0)
          .d(TunnerValues[2],ClosedLoopSlot.kSlot0)
          ...
          .p(TunnerValues[8],ClosedLoopSlot.kSlot1)
          .i(TunnerValues[9],ClosedLoopSlot.kSlot1)
          .d(TunnerValues[10],ClosedLoopSlot.kSlot1)
          .velocityFF(TunnerValues[11],ClosedLoopSlot.kSlot1)
        ...
        /*Configures motion limits*/
          ...
          .maxVelocity(MotionConstants[0],ClosedLoopSlot.kSlot0)
          .maxAcceleration(MotionConstants[1],ClosedLoopSlot.kSlot0)
          .allowedClosedLoopError(MotionConstants[2],ClosedLoopSlot.kSlot0)

          .maxVelocity(MotionConstants[0],ClosedLoopSlot.kSlot1)
          .maxAcceleration(MotionConstants[1],ClosedLoopSlot.kSlot1)
          .allowedClosedLoopError(MotionConstants[2],ClosedLoopSlot.kSlot1);
