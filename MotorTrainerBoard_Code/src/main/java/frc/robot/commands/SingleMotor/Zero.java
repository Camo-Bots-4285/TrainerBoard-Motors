...
public class Zero extends Command {
  ...
  public Zero(Neo_Single subsystem) {
  ...
  public void initialize() {
        Logger.recordOutput("Commands/Single_Motor_Zero", true);
  }
  ...
  public void execute() {
    ...
    m_REVSubsytem.Single_Motor.setTargetMechanismPosition(0);
  ...
  public void end(boolean interrupted) {
    Logger.recordOutput("Commands/Single_Motor_Zero", false);
  }
