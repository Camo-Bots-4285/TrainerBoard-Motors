...
public class CTRE_Talon extends SubsystemBase {
  ...
  /*Motion Constants */
    ...
    public CTRE_Talon(
        ...
        boolean Idle_Brake, //Bring in motor states
        boolean Inverted,
        double[] MotionProfile//Holds motor FF and PID for position and velocity
    ) {
    ...
    /*Set value to import or set values ot defualt if null */
      ...
      if(Idle_Brake==true){RunningIdle = NeutralModeValue.Brake;}else{RunningIdle = NeutralModeValue.Coast;}
      if(Inverted==true){talonFXConfigs.MotorOutput.Inverted = InvertedValue.Clockwise_Positive;}else{talonFXConfigs.MotorOutput.Inverted = InvertedValue.CounterClockwise_Positive;}

      if(MotionProfile[6]==0){GravityType=null;}else if(MotionProfile[6]==1){GravityType=GravityTypeValue.Elevator_Static;}else if(MotionProfile[6]==2){GravityType=GravityTypeValue.Arm_Cosine;}
      ...
      this.MotionProfile=MotionProfile;
        ...
        slot0Configs.kS = MotionProfile[1];//0.25;
        slot0Configs.kV = MotionProfile[2];//0.12;
        slot0Configs.kA = MotionProfile[3];//0.01;
        slot0Configs.kP = MotionProfile[4];//6;
        slot0Configs.kI = MotionProfile[5];//0;
        slot0Configs.kD = MotionProfile[6];//0.1;
        ...
        slot1Configs.kS = MotionProfile[8];
        slot1Configs.kV = MotionProfile[9];
        slot1Configs.kA = MotionProfile[10];
        slot1Configs.kP = MotionProfile[11];
        slot1Configs.kI = MotionProfile[12];
        slot1Configs.kD = MotionProfile[13];
        


        // Motion Magic settings
        var motionMagicConfigs = talonFXConfigs.MotionMagic;
        motionMagicConfigs.MotionMagicCruiseVelocity = MotionProfile[14];
        motionMagicConfigs.MotionMagicAcceleration = MotionProfile[15];
        motionMagicConfigs.MotionMagicJerk = MotionProfile[16];
        motionMagicConfigs.MotionMagicExpo_kV = MotionProfile[17];
        motionMagicConfigs.MotionMagicExpo_kA = MotionProfile[18];
    ...
    public void setTunerConstants(double[] new_MotionProfile, int SlotNumber) {
      ...
      double[] set_MotionProfile=MotionProfile;
        ...
        for (int i = 8; i <= 13; i++) {//Runs for loop to check is values have change
          if (new_MotionProfile[i] != (Double) null){set_MotionProfile[i]=new_MotionProfile[i];}//If values have changed changes them
            ...
            var slot0Configs = talonFXConfigs.Slot0;
            slot0Configs.kS = MotionProfile[8];//0.25;
            slot0Configs.kV = MotionProfile[9];//0.12;
            slot0Configs.kA = MotionProfile[10];//0.01;
            slot0Configs.kP = MotionProfile[11];//6;
            slot0Configs.kI = MotionProfile[12];//0;
            slot0Configs.kD = MotionProfile[13];//0.1;
    ...
    public void setMotionConstaints(double[] NewMotionConstants) {
        var motionMagicConfigs = talonFXConfigs.MotionMagic;
        double[] set_MotionConstants = MotionProfile;

        // Ensure the length of the NewMotionConstants array is sufficient
        if (NewMotionConstants.length < 5) {
            System.out.println("Error: NewMotionConstants array must have at least 5 elements.");
            return;
        }

        for (int i = 0; i <= 5; i++) {//Runs for loop to check is values have change
        if(NewMotionConstants[i]!=(Double)null){set_MotionConstants[i+13]= NewMotionConstants[i];}}

        motionMagicConfigs.MotionMagicCruiseVelocity = set_MotionConstants[14];
        motionMagicConfigs.MotionMagicAcceleration = set_MotionConstants[15];
        motionMagicConfigs.MotionMagicJerk = set_MotionConstants[16];
        motionMagicConfigs.MotionMagicExpo_kV = set_MotionConstants[17];
        motionMagicConfigs.MotionMagicExpo_kA = set_MotionConstants[18];
