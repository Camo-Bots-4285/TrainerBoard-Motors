  ...
  public static class BuildConstants {
    ...
    public class SingleMotorConstants {
        ...
        public static SparkMaxConfig getREVConfig()
        {
            ...
            .inverted(false)
            //.advanceCommutation(-120.0)//REV says 120 but that did not work -120 does
    ...
    public static final String NAME = "1_Shooter";
    
        public static final Angle TOLERANCE_POSITION  = Rotations.of(0.01);
        public static final AngularVelocity TOLERANCE_VELOCITY = RotationsPerSecond.of(0.01);
    
        public static final AngularVelocity CRUISE_VELOCITY = RotationsPerSecond.of(150);
        public static final AngularAcceleration ACCELERATION = RotationsPerSecondPerSecond.of(0.5);
        public static final Velocity<edu.wpi.first.units.AngularAccelerationUnit> JERK = ACCELERATION.per(Second);
    
        private static final double ROTOR_TO_SENSOR = 1;
        private static final double SENSOR_TO_MECHANISM = 1;
        ...
        public static final Mass WHEEL_MASS = Kilograms.of(0.1);
        public static final DCMotor DCMOTOR = DCMotor.getMinion(1);
        public static final MomentOfInertia MOI = KilogramSquareMeters
            .of(0.5*WHEEL_MASS.in(Kilogram)*Math.pow(WHEEL_RADIUS.in(Meter),2));
        ...
        public static final PID SLOT0_PID = new PID(5.0, 0.0, 0.0).withS(0.0); //Postion
        public static final PID SLOT1_PID = new PID(0.001, 0.0, 0.0).withV(0.08875).withS(0.1775); // Velocity

        public static final AngularVelocity IDLE_VELOCITY = RotationsPerSecond.of(0);
        public static final AngularVelocity SCORE_VELOCITY = RotationsPerSecond.of(20);
        public static SparkMaxConfig getREVConfig()
        {
            SparkMaxConfig config = new SparkMaxConfig();
