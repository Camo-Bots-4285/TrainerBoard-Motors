...
import frc.lib.W8.util.Device.DIO;
import frc.lib.W8.util.Device.PWM;
...
public class Ports {
    ...
    public static final Device.CAN RotarySubsystemMotorMain = new CAN(1, "rio");
    public static final Device.CAN RotarySubsystemMotorFollower = new CAN(2, "rio");
